...
* add resource change tracking and downstream sync improvements ([efe6082](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/efe60823abd1405dca913eec1519bcf57a3accb2))
* add streamable http transport and release automation ([0717f31](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/0717f31ae503c19824fdd14fb05394197b8b11a9))
* Add symbolic command language and operator executors ([639f86a](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/639f86a4aeeae925c0b916cffc297d4253c8ed6f))
* **ci:** add commitlint, changelog-sections, and downstream sync workflow ([802575d](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/802575df5bb95a1f6cecf1dcd9a9d3f3cfc8fd8e))
* **ci:** auto-merge manual changelog entries into Release Please releases ([d2f2f52](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/d2f2f52f330f3063f394a80988c011de692f7717))
* **ci:** migrate to OIDC trusted publishing for npm ([e71d272](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/e71d272f833d1e983f717eb11d31b6a492c24a59))
* **ci:** modernize Release Please and npm-publish workflows ([7bb1303](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/7bb1303a53f998ca10bab6f621eecf548864881a))
* **config:** add registerWithMcp toggle for MCP resources ([471ed14](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/471ed14e8a2a4bd63dd44aabbec8f97a5869e513))
* **config:** expand resources config with granular per-type controls ([ddcdba2](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/ddcdba2f62a700bfaf013f17ee16f21927cba110))
* **dist:** separate public and private prompts for distribution ([fee7c12](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/fee7c12e21c5b525501764f74fbff80ace08805a))
* **docs:** add Remotion animation system for documentation videos ([0a40c4d](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/0a40c4de20807ae4600294bee983ce852992311f))
* enhance README with interactive prompt management features ([13afaa9](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/13afaa968bc2330f80a183a71f7eb367dc40c3f6))
* enhance server startup options and help documentation ([f315f33](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/f315f331cbf1112a5d5163018cfbd0bfc23cd413))
* **eslint:** add claude-plugin custom ESLint rule ([876b431](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/876b431f428b8a8df644ae4d89c31d483c45e9d2))
* **execution:** execution ledger Tiers 1-5 + Phase 4 SQLite cleanup ([#131](https://github.com/acadiancapitalpartners/claude-prompts-mcp/issues/131)) ([9fd4520](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/9fd45205771fae4c8d603bb32a2e0ed9956b51ad))
* extension dep sync, repetition operator, hook fuzzy matching ([efbdc30](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/efbdc3018b44b50bb7383d30f23b3239cc0b7905))
* **gates:** add response blocking and gate event emission in pipeline ([914a074](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/914a0740db3d793d259d502ae9a354077b85c3d3))
* **gates:** add script_tool verification criteria and fix schema normalization ([d12c278](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/d12c2789897d5365374c7e1d4d7e0e0268adc679))
* **gates:** clarify gate vocabulary, add path-verification gate, documentation pass ([#132](https://github.com/acadiancapitalpartners/claude-prompts-mcp/issues/132)) ([7d46db0](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/7d46db02e0d55a348372dc8a3181e7acb916c78a))
* **gates:** implement intelligent gate selection with 5-level precedence system ([b8e1c11](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/b8e1c11a3bf8a411f65448812112e7c2555a9c8e))
* **gemini:** add Gemini CLI extension support ([50587c6](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/50587c61fa922eee5400614bde24ec3bf9103cbe))
* **gemini:** align hooks with Claude plugin infrastructure ([c35e4f0](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/c35e4f0d678d1bd3c36725f9ede1b7a191bab785))
* **hooks:** add chain step visibility with IDs for workflow preview ([ff25d5e](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/ff25d5ec0f26c1556f55353fb41e97e897ff6792))
* **hooks:** add chain workflow visibility before execution ([73f2d90](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/73f2d903fd23606a93159ad1322f31132fb6f63b))
* **hooks:** add hook-level fuzzy matching for token efficiency ([08a9114](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/08a9114ef9f8272247c08f4e819aeb0bad3a1246))
* **hooks:** add server-side hook registry and MCP notification system ([86ba115](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/86ba11564d6363e9353b34cfcef0a7e662d50b96))
* **hooks:** auto-extract argument options from templates and descriptions ([d88df9a](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/d88df9a944d9eee574d4512da876b74b08470f4f))
* **hooks:** auto-regenerate contracts on source change ([9b21afa](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/9b21afa192cddf42bd43d46a02a9557ee00c4d2b))
* **hooks:** improve prompt_engine directive clarity and token efficiency ([b62f8d3](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/b62f8d3dd3e7aa4794e9b29bccb0ccc081bd49b1))
* **hooks:** validate operator values against registered server resources ([30cba3a](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/30cba3ac12c88e74b0b7e70bbcd8bfe079a9505b))
* implement enterprise-grade CI/CD pipeline with comprehensive testing framework ([#10](https://github.com/acadiancapitalpartners/claude-prompts-mcp/issues/10)) ([25e7f59](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/25e7f59d41801bc4cc4cb6d01158c262d2064b9a))
* implement Phase 1 - Enhanced Category Parsing System ([1506755](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/150675589e650d5a06d018e7884658a31965dcf2))
* multi-platform extension support with enhanced hooks and gate system ([27b94ec](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/27b94ecb3946a3a5a227fe5c0dbbbe8792b7cc71))
* **npm:** include hooks in npm package ([b530621](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/b530621b55c4932efcc31ddbd1a1cb8d49b97451))
* **operators:** add generated operator patterns and enhance symbolic parsing ([7182e2a](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/7182e2ae03fe86e707f78b1cea843ce39b0dd8fb))
* **parser:** enhance case-insensitive prompt matching and add strategic implementation ([628b09c](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/628b09c3e7b6017317eaa966de9b6fd756f77e15))
* **parsers:** add framework-aware quote parsing for @ operator ([9555122](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/95551220836997760e735ab6b7121548f05dc504))
* **plugin:** add server/resources directory for plugin deployment ([2d21a86](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/2d21a864a278a3c7a3abbcb4e53843ae65b39ea5))
* **plugin:** add SessionStart hook for dependency installation ([3896fb9](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/3896fb9b967fe8761ef8f1ee0f4d2d84bf1ec139))
* **plugin:** persist user data outside cache directory ([e59c64b](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/e59c64b5fc37e989783db8070cceaab320e7be4f))
* **plugin:** unify plugin with YAML resources, version history, and script tools ([0963d4a](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/0963d4ac56da09dc35d08fc3070c4b846b191fb1))
* **prompts:** add scaffold_project chain for interactive project setup ([28401f6](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/28401f6bf5294f201e63d595e71940db86c84f3e))
* **ralph:** context isolation for long-running verification loops ([f1c1014](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/f1c1014f75dc719d919013dd3dbd9219d2900fe6))
* re-introduce hot-reloading for prompots ([720f96b](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/720f96b9810a2e3675eb305b3e69683a64bb3982))
* release 1.2.0 with CI validation and gate refactoring ([75ec3e8](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/75ec3e83e06e6c7753045778d770fc80773e77e0))
* **release:** add automatic version sync on npm version ([5635224](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/56352244099857bfc170c749ca8b451812d82703))
* **resources:** add MCP logs resources for runtime observability ([5f0025f](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/5f0025fcece76e3ed593246d30da54554e7be58f))
* **resources:** implement MCP Resources protocol for token-efficient access ([80d56d2](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/80d56d22a4b25b93270e9d8718c3b0ad95641f68))
* **runtime:** multi-source resource overlay and path consolidation ([2f5d751](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/2f5d75106605d254679a54871deb5d0e7ee46649))
* **scripts:** add skills-sync CLI for cross-client skill distribution ([351291c](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/351291c5827e17cd36b34588d6ee2646b561eebc))
* **server:** add identity resolution, delegation operator, and methodology assertions ([#76](https://github.com/acadiancapitalpartners/claude-prompts-mcp/issues/76)) ([913c2d9](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/913c2d9d3dc8d65a64e47c29f310feeca0f0c937))
* **server:** add OpenTelemetry instrumentation and observability infrastructure ([48e720f](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/48e720f684f8fc5822c66c7242aa414bc2e4740f))
* shell verification presets and checkpoint resource type ([ca24027](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/ca240274e3df495f87879b28e5492c4289cfb489))
...
* add missing nunjucks dependency for template processing ([4f78114](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/4f781144de43b72d0b29603337ba44d4ba61bb2a))
* add required metadata for plugin menu navigation ([72cd845](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/72cd845e96cd04c37ec32eb1584f17f8c57e03b2))
* **ci:** add checkout step before changelog merge in Release Please workflow ([d68d0f1](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/d68d0f19781079c114c46d29543d1f780a1edda9))
* **ci:** add provenance fallback for tlog conflicts ([2d55ce2](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/2d55ce28716b4d59bf21143d938eecdec4949541))
* **ci:** align extension-publish tags with Release Please config ([19a0024](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/19a002439ade437c7856c03164b52c4196d821a1))
* **ci:** centralize downstream version sync in extension-publish ([e8c25e0](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/e8c25e0d7bb925ce517c2aa72e226d4c4ebf0be0))
* **ci:** consolidate workflows and fix Docker paths ([42efb12](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/42efb126455c16ac46ba349091977351eb337f82))
* **ci:** fix changelog merge target and set release-as 2.1.0 ([cc2ed76](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/cc2ed76cb5bf9e760743aad6201049e983227396))
* **ci:** handle Release Please PR output as JSON ([8559c74](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/8559c74e2c819961c644b769bc34f5a06e4f0c82))
* **ci:** remove distribution version check from npm-publish workflow ([8dbcf68](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/8dbcf6850d0f7113343d676102457a8ffd1eddc7))
* **ci:** skip action inventory verification for bundled builds ([dd299e5](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/dd299e5f65fe3ffe2184debf659b7a764b176fb0))
* **ci:** update extension-publish workflow for bundled distribution ([8d977e9](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/8d977e9c4daa8b8b7a6796bd66e6164ece662f86))
* clear lint regressions ([77db53a](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/77db53a850a93f5fd1b41fe53dc21cd2a258454f))
* **contracts:** add prettier formatting to contract generator ([6096c67](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/6096c67aa1151f402670081c8871237a2c9888ef))
* **contracts:** format all generated TypeScript files ([0e4c9af](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/0e4c9aff57867ac46e905fc1e3be4e58b271a946))
* correct marketplace.json schema (source not path) ([6d08e63](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/6d08e63f06bb6cb6c20a438d23823174e4c24bfb))
* correct source path (relative to marketplace.json) ([e281b48](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/e281b48728fe3c390058fdaf1126c4811e04ea7c))
* **deps:** add missing 'diff' dependency for text-diff-service ([12b70db](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/12b70dbfb0f5a53be24c084cd6505133f4458fd5))
* **deps:** update dependency chokidar to v5 ([b10476f](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/b10476f3547051ea5c7296e275c69f2d0561eb5b))
* **docker:** update Dockerfile for renamed docs and styles directory ([35144c8](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/35144c8905c00c5d2a2901a20796ecab4904d1aa))
* **docs:** remove invalid color property from mermaid linkStyle ([d086ca1](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/d086ca1ee22818c93d427b93d830463c9bb49d37))
* **gemini:** align extension with Claude plugin v1.1.1 ([fb3413c](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/fb3413c399956ab510f140db8c8802d8938714cb))
* **gemini:** resolve symlinks before path calculation ([77da3bc](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/77da3bc655a8fdee67b301ec47f993763ce42bcb))
* **hooks:** add quick-check mode to prevent SessionStart blocking ([c4b3f94](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/c4b3f94d5d1be5b579a25f825f6633e7937cf129))
* **hooks:** allow generated file deletions for feature removal ([a8fcb24](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/a8fcb24f310096fe617ac50fb1840acdeb5778f8))
* **hooks:** filter deleted files from pre-push prettier check ([5ee1fb2](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/5ee1fb28bb02faa497846c2e8a6c8e8ecb370f8d))
* **hooks:** make dev-sync portable across environments ([4aa1190](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/4aa119040f21669c2f5e52e7810ed32198f547dc))
* **hooks:** register delegation-enforce.py in PreToolUse hooks ([0c7c3a4](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/0c7c3a4f3ebd78527bacbe821991c248214ad8c5))
* **hooks:** remove stale hooks-state.db fallback from ralph-stop ([2be57ab](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/2be57ab1102083d9913dd3f87502d011db444180))
* **hooks:** resolve generated operators Ruff typing issue ([a956fb2](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/a956fb2a7df0f0439d5bd39f7343c3dfb071a452))
* **hooks:** update Python hooks for new gate server format ([1b0ddf5](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/1b0ddf50367e8de7fb447b2e95b6d80ecec2d207))
* **hooks:** use --diff-filter=ACMR instead of shell workaround ([edb9526](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/edb95267b3055cadf7198a38fd7b3dc0580069fb))
* **hooks:** use SSOT registry for operator detection in prompt-suggest hook ([2fe7a4f](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/2fe7a4f58ef93632e70cd2087af9746e00be9108))
* **hot-reload:** support chokidar 5 upgrade ([1db39c8](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/1db39c8982706e36d70b2eec1580631594d99fa3))
* **loader:** allow system-only prompts and fix scaffold prompt loading ([8616e46](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/8616e4644079348a61c9cc9d7e9ba4f6257997fb))
* **mcp-tools:** fix prompt update field clearing and simplify update workflow ([5a2800e](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/5a2800e6f925796c6d8c679d6aeaff3672f8aa33))
* **mcp-tools:** remove section/section_content from router pass-through ([61072df](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/61072df2c71ae61ed7002dd21802b8f06c9dd8c2))
* **npm:** Include methodologies folder in published package ([9bad683](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/9bad68308e017bc0c362e28f7829d3220bcd7116))
* **parsers:** preserve arguments after * N repetition operator ([649bae3](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/649bae3d3dcaf7c6ec53fda1da18a90aaed6d705))
* **parsers:** quote-aware operator detection prevents special chars in args from breaking prompt resolution ([0beb3ff](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/0beb3ff2009a487bb5a39d0367429b8e07934be1))
* **parsers:** simplify argument assignment for unstructured text ([061cd0f](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/061cd0f1e8483e258ffff13e5576b61eddac15d2))
* **parsers:** strip leading delegation operators before argument extraction ([07ed2ee](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/07ed2ee7498956b5690fa555c94bf63db95acbe0))
* **pipeline:** use provider function for prompt cache synchronization ([f092837](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/f09283778ff2474b1a30d8a40c6a8f0827069c97))
* **plugin:** correct .mcp.json schema and improve dev workflow ([9927529](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/99275299847de16f1bd42d13525e8cd4c662e624))
* **plugin:** include server/dist for plugin installation ([5f1edd3](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/5f1edd3ed144e27a3380ea2d8e52890b78a836c5))
* **plugin:** remove duplicate hooks reference causing load failure ([c6c3ca6](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/c6c3ca648110e216b630829abab947d88cd036ac))
* prune useless prompts ([daec104](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/daec104cecf6719a080af777899849e2d8493156))
* regenerate contract artifacts and update lint baseline ([0a0e67d](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/0a0e67d9d62c74e552bb69bcad00299e5e1b23b3))
* **release:** correct release-please config paths ([20662ec](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/20662ecb89f5ff84c8baea6321774141b049eca7))
* **release:** remove submodule path checks from distribution validation ([1a3220e](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/1a3220e19e64dbada9ca90a1e6a84f7fc5651cbe))
* **release:** version sync ([#51](https://github.com/acadiancapitalpartners/claude-prompts-mcp/issues/51)) ([6bd6039](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/6bd6039765edae189fe83ca13f60a8a27a178d73))
* **release:** version sync ([#54](https://github.com/acadiancapitalpartners/claude-prompts-mcp/issues/54)) ([33f9e85](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/33f9e85349e38445905d6471742c54910dc9178e))
* Remove accidentally committed node_modules, update .gitignore ([ed452ac](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/ed452acd60df2c76d94c43eceb09a66a42edf386))
* return simple text responses for MCP tool visibility in Claude Code ([7980567](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/7980567d540c04390eb90c44d7c3ed1345394291))
* **runtime:** bridge PathResolver to jsonUtils via PROMPTS_PATH env var ([3d4505b](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/3d4505b3c982f2952fc56f574ba5228b801d290e))
* **scripts:** check dependency range instead of package version for opencode ([3f3fa9e](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/3f3fa9e6fd4089c0202e3bee74ce4f8cd379790c))
* **scripts:** generate Ruff-compatible Python operator types ([aa201d7](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/aa201d7166d35dd7b91cc6fa0eded6ea848e10c9))
* **scripts:** update extension deps list and lint ratchet baseline ([bffac0d](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/bffac0d0ca73ecca35eb8373ae349182ebba5d6f))
* source must start with ./ ([b2482f1](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/b2482f1dc79ec65b3e60d7d0192624e18a8a71ee))
* source path relative to repo root ([f2e3020](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/f2e302058137a49bd2bc195cccc87b71973a38b9))
...
* add agent.md documentation ([4df0265](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/4df0265444476f4949876623e614acbc85228097))
* add changelog entry for 1.4.6 release ([602791e](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/602791e3ae66f3a0914b1200f20d9bb2530da00d))
* Add dependency updates tracking plan ([589f119](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/589f119569f323289ec1be4b8566787624960363))
* add LIQUESCENT methodology and update changelog ([26a639b](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/26a639b59c89f7f0f223dc65fb5a8201a7740d06))
* add release automation section to CONTRIBUTING.md ([d345701](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/d345701cbd6bc57dda80f11429326cf7bed71b35))
* **changelog:** document breaking path resolution changes ([5918e16](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/5918e1653f9cf4810998466567ce72f40b0808ee))
* **ci:** update downstream sync comment to reflect Dependabot approach ([82e15cd](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/82e15cd32251579da6ab6ab862b244b493de5c78))
* Clarify parallel and conditional operators are reserved ([1b67af9](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/1b67af9f4854c86d2055245e164a8c0d4d95e955))
* **cleanup:** record chokidar post-upgrade rationale ([b6740e2](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/b6740e21d11bf20a324c3e511a97ad67c28924c9))
* consolidate and restructure documentation ([ff273c9](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/ff273c909149a238dacb20b27c498986ed7a0f43))
* consolidate documentation and remove completed plans ([1e52295](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/1e52295ce182e20753d7444293086eab81652206))
* **contracts:** update prompt_engine for shell verification ([9355eb2](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/9355eb21fff89b9637d700a6b15301f61beafb8e))
* document plugin hooks and promote Claude Code installation ([f9fa97f](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/f9fa97ff86845c9c5997a77d3832b420d7fa31d1))
* **gates:** update gates.md for resources directory restructure ([fdfe8e5](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/fdfe8e537dc68d3e2f19fd9ba0a92f3585ba8131))
* **hooks:** improve README structure and add test examples ([0212110](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/0212110b072d9f5e87411e1677cef0cf49fab311))
* Improve framework documentation and update dependencies ([aebabd4](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/aebabd4e480ca1d160f5d8e530a2486355e317f0))
* improve render pipeline diagram accuracy ([32c46f7](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/32c46f7014b447e29ad22198ac0618d8add2a0a2))
* modernize CONTRIBUTING.md, add GitHub templates, align project config ([3afbe39](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/3afbe39c475ddc5dc4054b5ffd30f5bc90a29cd6))
* **plan:** expand bundled-distribution migration with release strategy, CI artifacts, and validation/rollback ([f418fe2](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/f418fe26feac806f0144347a1e57a84d35df6fdf))
* **readme:** add development setup for all platforms ([5d178cc](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/5d178ccec1f5f4ca39eee7b4f7dc6df00d04f9cd))
* **readme:** add marketplace prerequisite to Quick Start ([61d1c2e](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/61d1c2e858ee0cfb37bbfed2ea6a602d9ccf4bd2))
* **readme:** add OpenCode, reorganize installation sections ([540394d](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/540394de0cccc6e44d0afa453fc8fa6b0e8f1f21))
* record open PR validation wave ([81d383a](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/81d383a51191570cf4314caeec29e7d9dcbb540c))
* record package wave results ([0e7de90](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/0e7de90a611b5151f6e4a095ed4e49bfa49ba9ff))
* record remaining package wave ([d398fe5](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/d398fe54b37d279dc23616453033350a5d1784d8))
* Redesign pipeline diagram to show WHY not just WHAT ([eff98be](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/eff98bedfbecf705e9011fca68740bf8e640980c))
* **release:** add distribution architecture section ([0520734](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/05207341b82cfc9e2bf719713bc64178ae36a4d8))
* remove orphaned [Unreleased] section from pre-v2.0.0 changelog ([73ad697](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/73ad69785c60ddccdd6decf52b6f86f57701ac74))
* **repo:** align repo links to minipuft/claude-prompts; update release process and config schema ([13b3616](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/13b3616c46d5aa8f5eaeae71f71ae72c632a24e8))
* Restructure READMEs with Problem/Solution/Expect format ([23ff8dc](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/23ff8dc5c2c460e961693b023327de4a5de4e15f))
* standardize inline doc links with TIP callouts across README ([ebd6241](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/ebd62412b08b03a0f335b12850750f8d0546144e))
* update changelog and readme for 1.4.5 features ([0ea746f](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/0ea746f9d695b7814c3d0870464580e26a120a98))
* update changelog for unreleased changes ([25c659e](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/25c659e21230b1adca71789541dadd1ac1416996))
* update changelog for v1.5.0 ([26529b7](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/26529b72fb173cc68ec22b5642ee1912570b2148))
* update CLAUDE.md and fix gate analysis conditional ([9f3dd84](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/9f3dd84ce9d36b8bcc8491c88caf573e5b112d2d))
* update demo video plan to WebP format and re-recording schedule ([b87aef7](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/b87aef7f106f7502ee1e2e253deb05606b4b5d4c))
* update extension descriptions to match README value proposition ([5630c6a](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/5630c6ab295006118d9567deb1e1f4720c515f99))
* update gemini repo link to gemini-prompts ([d195871](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/d195871ec0327b111ef0304cb9dd0a01f1d71f9c))
* update path configuration and release process documentation ([abf3457](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/abf345766f8fd611c5b0ad1e502866f6d81cc88b))
...
* **ci:** downgrade to minor bump — path resolution change is internal only ([c550b74](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/c550b74d4a220ba44ecb09654c0542e380bd56bd))
* **ci:** release as 2.0.0 — AGPL license change is breaking ([7e5d024](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/7e5d024645831005c55f86281364efa90312ef82))
* prepare 1.3.0 release ([225ebe6](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/225ebe6da4bb8f5c13ab6d750690249e0ed9502b))
* **server:** migrate license from MIT to AGPL-3.0-only ([36961fa](https://github.com/acadiancapitalpartners/claude-prompts-mcp/commit/36961fad8bac2cb4b4f9b232ece905be91fe16f8))
